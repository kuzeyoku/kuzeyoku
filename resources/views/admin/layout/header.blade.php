    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                @svg('ri-notification-3-line') <span class="badge rounded-pill">4</span>
            </a>
            <div class="dropdown-menu notifications">
                <div class="topnav-dropdown-header">
                    <span class="notification-title">Bildirimler</span>
                    <a href="javascript:void(0)" class="clear-noti"> Temizle </a>
                </div>
                ...
                <div class="topnav-dropdown-footer">
                    <a href="activities.html">Tümünü Görüntüle</a>
                </div>
            </div>
        </li>
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <a class="dropdown-item logout pb-0"
                        href="{{ route('admin.auth.logout') }}">@svg('ri-logout-box-r-line')Logout</a>
                </div>
            </div>
        </li>
    </ul>
