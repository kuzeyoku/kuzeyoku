<div class="form-group">
    ...
    {!! Form::select('status', App\Enums\StatusEnum::getOnOffSelectArray(), config('setting.maintenance_status')) !!}
</div>
<div class="form-group">
    {!! Form::label('message', __('admin/setting.maintenance_message')) !!}
    {!! Form::textarea('message', config('setting.maintenance_message'), [
        'placeholder' => __('admin/setting.maintenance_message_placeholder'),
    ]) !!}
</div>
<div class="form-group">
    {!! Form::label('end_date', __('admin/setting.maintenance_end_date')) !!}
    {!! Form::date('end_date', config('setting.maintenance_end_date')) !!}
</div>
