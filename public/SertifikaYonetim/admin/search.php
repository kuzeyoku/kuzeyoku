                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="search.php">Öğrenci Ara</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Öğrenci Ara</strong>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                       ...
                                       <div class="form-group row">
                                                        <label class="col-4 col-form-label" for="example-email" style="padding-left: 50px"><strong>Öğrenci ya da Kurs Arayın</strong></label>
                                                        <div class="col-6">
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">Tc No = "<?php echo $sdata;?>" ile ilgili sonuçlar </h4> 
...
$sql="SELECT * from ogrenciler where TcNo like '%$sdata%' || NameSurname like '%$sdata%' || Course like  '%$sdata%'";
