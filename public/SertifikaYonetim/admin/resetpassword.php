...
<head>
    ...
    <title>Fc Şifremi Unuttum</title>
...
<body class="bg-dark" style=" background-image: url('images/bg.jpg');">
    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <h3 style="color: white">Sertifika Sorgulama Sistemi - Reset - Şifre </h3>
                    <hr  color="red"/>
                </div>
    ...
    echo $msg;
                        ...
                        <div class="form-group">
                                ...
                                <input type="password" class="form-control" placeholder="Yeni Şifreniz" name="newpassword" required="">
                        </div>
                            <div class="form-group">
                                <label>Tekrar Yeni Şifre</label>
                                <input type="password" class="form-control" placeholder="Tekrar Yeni Şifreniz" name="confirmpassword" required="">
                        </div>
                                <div class="checkbox">
                                    <label class="pull-left">
                                <a href="index.php">Oturum Aç</a>
                            </label>
